...
export class AffiliationController {
    ...
    async createAffiliatedClub(
        ...
        return await this.affiliationService.createAffiliatedClub(body, adminName, file);
    }
    ...
    async updateAffiliatedClub(
        ...
        const adminName = req.user?.name || 'system';
        return await this.affiliationService.updateAffiliatedClub(body, adminName, file);
    }
    ...
    async createRequest(@Body() body: any, @Req() req: any) {
        ...
        return await this.affiliationService.createRequest({ ...body, membershipNo: req.user.id }, sender);
    }
}
