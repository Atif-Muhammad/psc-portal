...
export class SportService {
    ...
    async createSport(payload: CreateSportDto, createdBy: string, files: Express.Multer.File[] = []) {
    ...
    async updateSport(id: number, payload: Partial<CreateSportDto>, updatedBy: string, files: Express.Multer.File[] = []) {
            ...
            data: {
                ...
                sportCharge: {
                    ...
                    create: payload.sportCharge?.map((c) => ({
                        ...
                        updatedBy,
                        createdBy: updatedBy, // Since we deleteMany and recreate, it's safer to treat as new or pass original
                    })),
                },
                updatedBy,
            },
