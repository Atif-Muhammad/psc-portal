...
export default function Sports() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <Card className=""><CardContent className="p-0">
            ...
            <div className="mt-6 pt-4 border-t bg-gray-50/50 -mx-6 px-6 py-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="text-xs font-medium">{viewSport?.createdBy || "System"}</div>
                </div>
                <div>
                  <Label className="text-[10px] text-gray-400 uppercase">Created At</Label>
                  <div className="text-xs text-gray-600">
                    {viewSport?.createdAt ? new Date(viewSport.createdAt).toLocaleString("en-PK") : "N/A"}
                  </div>
                </div>
                <div>
                  <Label className="text-[10px] text-gray-400 uppercase">Last Updated By</Label>
                  <div className="text-xs font-medium">{viewSport?.updatedBy || viewSport?.createdBy || "System"}</div>
                </div>
                <div>
                  <Label className="text-[10px] text-gray-400 uppercase">Last Updated</Label>
                  <div className="text-xs text-gray-600">
                    {viewSport?.updatedAt ? new Date(viewSport.updatedAt).toLocaleString("en-PK") : "N/A"}
                  </div>
                </div>
              </div>
            </div>
