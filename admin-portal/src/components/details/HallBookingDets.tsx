                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Value>{getEventTypeDisplay(booking.eventType)}</Value>
                    </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Value className="font-bold">{booking.numberOfGuests.toLocaleString()}</Value>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="p-3 bg-blue-50 border border-blue-200 rounded-md">
                    <div className="flex justify-between items-start">
                      <div>
                        <div className="font-medium">{booking.member?.Name || booking.memberName}</div>
                        <div className="text-sm text-gray-600">
                          Membership: #{booking.member?.Membership_No || booking.Membership_No}
                        </div>
                      </div>
              ...
              <div className="p-4 bg-orange-50 border border-orange-200 rounded-lg">
                ...
                <div className="space-y-3 mt-4 text-xs">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <Label>Requested By</Label>
                      <Value>{booking.cancellationRequest.requestedBy}</Value>
                    </div>
                    <div>
                      <Label>Status</Label>
                      <Value className="uppercase">{booking.cancellationRequest.status}</Value>
                    </div>
                  </div>
                  <div>
                    <Label>Reason</Label>
